 ...
 */
@RestController
public class ApsRollingForecastFactoryCapacityApiImpl implements
    ApsRollingForecastFactoryCapacityApi {
   ...
   *
   */
  public @Override ApsRollingForecastFactoryCapacityInsertRes insert(
...
//    return new ApsRollingForecastFactoryCapacityInsertRes().setCount(1);
   ...
   *
   */
  public @Override ApsRollingForecastFactoryCapacityDeleteByIdListRes deleteByIdList(
      ApsRollingForecastFactoryCapacityDeleteByIdListReq req) {
   ...
   *
   */
  public @Override ApsRollingForecastFactoryCapacityUpdateByIdRes updateById(
      ApsRollingForecastFactoryCapacityUpdateByIdReq req) {
    apsRollingForecastFactoryCapacityService.updateById(
        $.copy(req, ApsRollingForecastFactoryCapacity.class));
  ...
  public @Override void queryPageListExport(
      ApsRollingForecastFactoryCapacityExportQueryPageListReq req) {
    DynamicsPage<ApsRollingForecastFactoryCapacityExportQueryPageListInfoRes> page = queryPageList(
        req);
    List<ApsRollingForecastFactoryCapacityExportQueryPageListInfoRes> list = page.getDataList();
    // 类型转换，  更换枚举 等操作
    List<ApsRollingForecastFactoryCapacityExportQueryPageListInfoRes> listInfoRes = $.copyList(list,
        ApsRollingForecastFactoryCapacityExportQueryPageListInfoRes.class);
    PoiExcelUtil.export(ApsRollingForecastFactoryCapacityExportQueryPageListInfoRes.class,
        listInfoRes, "滚动预测");
  }

  public @Override ApsRollingForecastFactoryCapacityImportRes importData(
      @RequestParam("file") MultipartFile file) {
    List<ApsRollingForecastFactoryCapacityImportReq> reqList = PoiExcelUtil.readData(file,
        new ApsRollingForecastFactoryCapacityImportListener(),
        ApsRollingForecastFactoryCapacityImportReq.class);
    // 类型转换，  更换枚举 等操作
    List<ApsRollingForecastFactoryCapacity> readList = $.copyList(reqList,
        ApsRollingForecastFactoryCapacity.class);
  ...
  public @Override ApsRollingForecastFactoryCapacityQueryByIdListRes queryByIdListRes(
      ApsRollingForecastFactoryCapacityQueryByIdListReq req) {
    MPJLambdaWrapper<ApsRollingForecastFactoryCapacity> q = new MPJLambdaWrapper<ApsRollingForecastFactoryCapacity>(
        ApsRollingForecastFactoryCapacity.class)
        .selectAll(ApsRollingForecastFactoryCapacity.class)
        .in(ApsRollingForecastFactoryCapacity::getId, req.getIdList());
    List<ApsRollingForecastFactoryCapacity> list = this.apsRollingForecastFactoryCapacityService.list(
        q);
    List<ApsRollingForecastFactoryCapacityDto> dataList = $.copyList(list,
        ApsRollingForecastFactoryCapacityDto.class);
