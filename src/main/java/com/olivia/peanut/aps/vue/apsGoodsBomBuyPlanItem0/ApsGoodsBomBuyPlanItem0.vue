<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      <el-form-item label="计划ID" prop="buyPlanId">
        <el-input v-model="queryParams.data.buyPlanId" clearable placeholder="请输入计划ID"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="ID" prop="bomId">
        <el-input v-model="queryParams.data.bomId" clearable placeholder="请输入ID" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="购买数量" prop="bomBuyCount">
        <el-input v-model="queryParams.data.bomBuyCount" clearable placeholder="请输入购买数量"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="apsGoodsBomBuyPlanItem0List" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="计划ID" prop="buyPlanId">
          <el-input v-model="form.buyPlanId" clearable placeholder="请输入计划ID"/>
        </el-form-item>
        <el-form-item label="ID" prop="bomId">
          <el-input v-model="form.bomId" clearable placeholder="请输入ID"/>
        </el-form-item>
        <el-form-item label="bom 编码" prop="bomCode">
        ...
        <el-form-item label="购买数量" prop="bomBuyCount">
          <el-input v-model="form.bomBuyCount" clearable placeholder="请输入购买数量"/>
        </el-form-item>
        <el-form-item label="商品零件ID" prop="goodsBomId">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      form: {
        ...
        bomBuyCount: undefined,
        goodsBomId: undefined,
        id: undefined
      },
      // 表单校验
      rules: {
        buyPlanId: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
        ...
        bomBuyCount: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
  ...
  created() {
    document['pagePath'] = '/apsGoodsBomBuyPlanItem0'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsGoodsBomBuyPlanItem0List = response.dataList
