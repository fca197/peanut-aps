<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="apsOrderGoodsSaleConfig0List" @selection-change="handleSelectionChange">
...
export default {
  ...
  created() {
    document['pagePath'] = '/apsOrderGoodsSaleConfig0'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsOrderGoodsSaleConfig0List = response.dataList
