<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="apsGoodsForecastMainGoodsDataList" @selection-change="handleSelectionChange">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 总条数
      total: 0,
      apsGoodsForecastMainGoodsDataList: [],
      // 弹出层标题
      title: '',
      // 是否显示弹出层
      open: false,
  ...
  created() {
    document['pagePath'] = '/apsGoodsForecastMainGoodsData'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsGoodsForecastMainGoodsDataList = response.dataList
