  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      <el-form-item label="排程版本ID" prop="schedulingDayId">
        <el-input v-model="queryParams.data.schedulingDayId" clearable placeholder="请输入排程版本ID"
      ...
      <el-form-item label="车间ID" prop="roomId">
        <el-input v-model="queryParams.data.roomId" clearable placeholder="请输入车间ID"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="配置类型 sale,part,bom ,sleep" prop="configBizType">
        <el-input v-model="queryParams.data.configBizType" clearable placeholder="请输入配置类型 sale,part,bom ,sleep"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="配置业务耗时(秒)" prop="configBizTime">
        <el-input v-model="queryParams.data.configBizTime" clearable placeholder="请输入配置业务耗时(秒)"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        configBizTime: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
