  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="${column.comment}" prop="goodsName">
        <el-input v-model="queryParams.data.goodsName" clearable placeholder="请输入${column.comment}"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="${column.comment}" prop="goodsRemark">
        <el-input v-model="queryParams.data.goodsRemark" clearable placeholder="请输入${column.comment}"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="总价" prop="goodsAmount">
        <el-input v-model="queryParams.data.goodsAmount" clearable placeholder="请输入总价"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="成本价" prop="goodsPrice">
        <el-input v-model="queryParams.data.goodsPrice" clearable placeholder="请输入成本价"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="成本价" prop="goodsTotalPrice">
        <el-input v-model="queryParams.data.goodsTotalPrice" clearable placeholder="请输入成本价"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="${column.comment}" prop="goodsUnit">
        <el-input v-model="queryParams.data.goodsUnit" clearable placeholder="请输入${column.comment}"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="成本价" prop="goodsUnitPrice">
        <el-input v-model="queryParams.data.goodsUnitPrice" clearable placeholder="请输入成本价"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="成本价" prop="goodsUnitTotalPrice">
        <el-input v-model="queryParams.data.goodsUnitTotalPrice" clearable placeholder="请输入成本价"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="apsOrderGoodsList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="${column.comment}" prop="goodsName">
          <el-input v-model="form.goodsName" clearable placeholder="请输入${column.comment}"/>
        </el-form-item>
        <el-form-item label="${column.comment}" prop="goodsRemark">
          <el-input v-model="form.goodsRemark" clearable placeholder="请输入${column.comment}"/>
        </el-form-item>
        <el-form-item label="总价" prop="goodsAmount">
          <el-input v-model="form.goodsAmount" clearable placeholder="请输入总价"/>
        </el-form-item>
        <el-form-item label="成本价" prop="goodsPrice">
          <el-input v-model="form.goodsPrice" clearable placeholder="请输入成本价"/>
        </el-form-item>
        <el-form-item label="成本价" prop="goodsTotalPrice">
          <el-input v-model="form.goodsTotalPrice" clearable placeholder="请输入成本价"/>
        </el-form-item>
        <el-form-item label="${column.comment}" prop="goodsUnit">
          <el-input v-model="form.goodsUnit" clearable placeholder="请输入${column.comment}"/>
        </el-form-item>
        <el-form-item label="成本价" prop="goodsUnitPrice">
          <el-input v-model="form.goodsUnitPrice" clearable placeholder="请输入成本价"/>
        </el-form-item>
        <el-form-item label="成本价" prop="goodsUnitTotalPrice">
          <el-input v-model="form.goodsUnitTotalPrice" clearable placeholder="请输入成本价"/>
        </el-form-item>
        <el-form-item label="订单状态" prop="goodsStatusId">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        goodsAmount: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
        ...
        goodsTotalPrice: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
        ...
        goodsUnitPrice: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
        }],
        goodsUnitTotalPrice: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
  ...
  created() {
    document['pagePath'] = '/apsOrderGoods'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsOrderGoodsList = response.dataList
