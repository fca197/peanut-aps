<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      <el-form-item label="预测ID" prop="forecastId">
        <el-input v-model="queryParams.data.forecastId" clearable placeholder="请输入预测ID"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="销售配置" prop="saleConfigId">
        <el-input v-model="queryParams.data.saleConfigId" clearable placeholder="请输入销售配置"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="apsGoodsForecastComputeSaleDataList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="预测ID" prop="forecastId">
          <el-input v-model="form.forecastId" clearable placeholder="请输入预测ID"/>
        </el-form-item>
        <el-form-item label="销售配置" prop="saleConfigId">
          <el-input v-model="form.saleConfigId" clearable placeholder="请输入销售配置"/>
        </el-form-item>
        <el-form-item label="年份" prop="year">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 总条数
      total: 0,
      apsGoodsForecastComputeSaleDataList: [],
      // 弹出层标题
      title: '',
      // 是否显示弹出层
      open: false,
  ...
  created() {
    document['pagePath'] = '/apsGoodsForecastComputeSaleData'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsGoodsForecastComputeSaleDataList = response.dataList
