  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="${column.comment}" prop="saleGoodsId">
        <el-input v-model="queryParams.data.saleGoodsId" clearable placeholder="请输入${column.comment}"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="${column.comment}" prop="useForecast">
        <el-input v-model="queryParams.data.useForecast" clearable placeholder="请输入${column.comment}"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="apsGoodsSaleItemList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="${column.comment}" prop="saleGoodsId">
          <el-input v-model="form.saleGoodsId" clearable placeholder="请输入${column.comment}"/>
        </el-form-item>
        <el-form-item label="${column.comment}" prop="saleConfigId">
          <el-input v-model="form.saleConfigId" clearable placeholder="请输入${column.comment}"/>
        </el-form-item>
        <el-form-item label="${column.comment}" prop="useForecast">
          <el-input v-model="form.useForecast" clearable placeholder="请输入${column.comment}"/>
        </el-form-item>
        <el-form-item label="${column.comment}" prop="supplierStatus">
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        saleGoodsId: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
        ...
        useForecast: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
  ...
  methods: {
    ...
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsGoodsSaleItemList = response.dataList
