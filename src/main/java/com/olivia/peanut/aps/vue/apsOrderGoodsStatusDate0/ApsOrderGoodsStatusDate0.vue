<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="apsOrderGoodsStatusDate0List" @selection-change="handleSelectionChange">
...
export default {
  ...
  created() {
    document['pagePath'] = '/apsOrderGoodsStatusDate0'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsOrderGoodsStatusDate0List = response.dataList
