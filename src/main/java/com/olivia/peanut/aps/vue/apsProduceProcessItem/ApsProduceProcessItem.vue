  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      <el-form-item label="生产路径 Id aps_produce_process" prop="produceProcessId">
        <el-input v-model="queryParams.data.produceProcessId" clearable
                  placeholder="请输入生产路径 Id aps_produce_process" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="耗时（秒）" prop="machineUseTimeSecond">
        <el-input v-model="queryParams.data.machineUseTimeSecond" clearable placeholder="请输入耗时（秒）"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    </el-form>
    ...
    <el-table v-loading="loading" :data="apsProduceProcessItemList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="生产路径 Id aps_produce_process" prop="produceProcessId">
          <el-input v-model="form.produceProcessId" clearable placeholder="请输入生产路径 Id aps_produce_process"/>
        </el-form-item>
        <el-form-item label="机器ID" prop="machineId">
        ...
        <el-form-item label="耗时（秒）" prop="machineUseTimeSecond">
          <el-input v-model="form.machineUseTimeSecond" clearable placeholder="请输入耗时（秒）"/>
        </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        machineUseTimeSecond: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
  ...
  created() {
    document['pagePath'] = '/apsProduceProcessItem'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsProduceProcessItemList = response.dataList
