<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="apsGoodsForecastMainList" @selection-change="handleSelectionChange">
  ...
  methods: {
    ...
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsGoodsForecastMainList = response.dataList
