<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="apsSchedulingIssueItemList" @selection-change="handleSelectionChange">
...
export default {
  ...
  created() {
    document['pagePath'] = '/apsSchedulingIssueItem'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsSchedulingIssueItemList = response.dataList
