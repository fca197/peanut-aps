  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="排程版本号" prop="schedulingDayVersionNo">
        <el-input v-model="queryParams.data.schedulingDayVersionNo" clearable placeholder="请输入排程版本号"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="排程日期" prop="schedulingDay">
        <el-input v-model="queryParams.data.schedulingDay" clearable placeholder="请输入排程日期"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="是否下发 0 否,1 是" prop="isIssuedThird">
        <el-input v-model="queryParams.data.isIssuedThird" clearable placeholder="请输入是否下发 0 否,1 是"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="工艺路径id" prop="processId">
        <el-input v-model="queryParams.data.processId" clearable placeholder="请输入工艺路径id"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="排产日配置版本表头" prop="headerList">
        <el-input v-model="queryParams.data.headerList" clearable placeholder="请输入排产日配置版本表头"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    </el-form>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="是否下发 0 否,1 是" prop="isIssuedThird">
          <el-input v-model="form.isIssuedThird" clearable placeholder="请输入是否下发 0 否,1 是"/>
        </el-form-item>
        <el-form-item label="工艺路径id" prop="processId">
          <el-input v-model="form.processId" clearable placeholder="请输入工艺路径id"/>
        </el-form-item>
        <el-form-item label="排产日配置版本表头" prop="headerList">
          <el-input v-model="form.headerList" clearable placeholder="请输入排产日配置版本表头"/>
        </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        isIssuedThird: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
