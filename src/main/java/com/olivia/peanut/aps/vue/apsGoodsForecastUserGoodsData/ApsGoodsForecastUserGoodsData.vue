<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="apsGoodsForecastUserGoodsDataList" @selection-change="handleSelectionChange">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 总条数
      total: 0,
      apsGoodsForecastUserGoodsDataList: [],
      // 弹出层标题
      title: '',
      // 是否显示弹出层
      open: false,
  ...
  created() {
    document['pagePath'] = '/apsGoodsForecastUserGoodsData'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsGoodsForecastUserGoodsDataList = response.dataList
