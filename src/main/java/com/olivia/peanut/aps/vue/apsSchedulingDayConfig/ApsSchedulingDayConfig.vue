  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="排程版本号" prop="schedulingDayNo">
        <el-input v-model="queryParams.data.schedulingDayNo" clearable placeholder="请输入排程版本号"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="排程版本名称" prop="schedulingDayName">
        <el-input v-model="queryParams.data.schedulingDayName" clearable placeholder="请输入排程版本名称"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="车间配置" prop="roomConfig">
        <el-input v-model="queryParams.data.roomConfig" clearable placeholder="请输入车间配置"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    </el-form>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="车间配置" prop="roomConfig">
          <el-input v-model="form.roomConfig" clearable placeholder="请输入车间配置"/>
        </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        roomConfig: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
