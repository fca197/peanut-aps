  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="${column.comment}" prop="configId">
        <el-input v-model="queryParams.data.configId" clearable placeholder="请输入${column.comment}"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="apsOrderGoodsProjectConfig0List" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="${column.comment}" prop="configId">
          <el-input v-model="form.configId" clearable placeholder="请输入${column.comment}"/>
        </el-form-item>
        <el-form-item label="工厂ID" prop="factoryId">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 总条数
      total: 0,
      apsOrderGoodsProjectConfig0List: [],
      // 弹出层标题
      title: '',
      // 是否显示弹出层
      open: false,
  ...
  created() {
    document['pagePath'] = '/apsOrderGoodsProjectConfig0'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsOrderGoodsProjectConfig0List = response.dataList
