  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="排序索引" prop="sortIndex">
        <el-input v-model="queryParams.data.sortIndex" clearable placeholder="请输入排序索引"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    </el-form>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="排序索引" prop="sortIndex">
          <el-input v-model="form.sortIndex" clearable placeholder="请输入排序索引"/>
        </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 表单校验
      rules: {
        machineNo: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
        }],
        machineName: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
