<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="apsGoodsForecastMainSaleDataList" @selection-change="handleSelectionChange">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 总条数
      total: 0,
      apsGoodsForecastMainSaleDataList: [],
      // 弹出层标题
      title: '',
      // 是否显示弹出层
      open: false,
  ...
  created() {
    document['pagePath'] = '/apsGoodsForecastMainSaleData'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsGoodsForecastMainSaleDataList = response.dataList
