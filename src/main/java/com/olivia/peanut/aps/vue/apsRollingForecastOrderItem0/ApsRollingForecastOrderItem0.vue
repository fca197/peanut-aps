  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="状态ID" prop="goodsStatusId">
        <el-input v-model="queryParams.data.goodsStatusId" clearable placeholder="请输入状态ID"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="状态开始时间" prop="statusBeginDate">
        <el-input v-model="queryParams.data.statusBeginDate" clearable placeholder="请输入状态开始时间"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    </el-form>
    ...
    <el-table v-loading="loading" :data="apsRollingForecastOrderItem0List" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="状态ID" prop="goodsStatusId">
          <el-input v-model="form.goodsStatusId" clearable placeholder="请输入状态ID"/>
        </el-form-item>
        <el-form-item label="状态开始时间" prop="statusBeginDate">
          <el-input v-model="form.statusBeginDate" clearable placeholder="请输入状态开始时间"/>
        </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 总条数
      total: 0,
      apsRollingForecastOrderItem0List: [],
      // 弹出层标题
      title: '',
      // 是否显示弹出层
      open: false,
      ...
      rules: {
        ...
        statusBeginDate: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
  ...
  created() {
    document['pagePath'] = '/apsRollingForecastOrderItem0'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsRollingForecastOrderItem0List = response.dataList
