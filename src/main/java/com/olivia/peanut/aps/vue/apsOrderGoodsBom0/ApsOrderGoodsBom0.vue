  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="aps_goods_bom ID " prop="goodsBomId">
        <el-input v-model="queryParams.data.goodsBomId" clearable placeholder="请输入aps_goods_bom ID "
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="状态" prop="goodsStatusId">
        <el-input v-model="queryParams.data.goodsStatusId" clearable placeholder="请输入状态"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="apsOrderGoodsBom0List" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="aps_goods_bom ID " prop="goodsBomId">
          <el-input v-model="form.goodsBomId" clearable placeholder="请输入aps_goods_bom ID "/>
        </el-form-item>
        <el-form-item label="商品ID" prop="goodsId">
        ...
        <el-form-item label="状态" prop="goodsStatusId">
          <el-input v-model="form.goodsStatusId" clearable placeholder="请输入状态"/>
        </el-form-item>
        <el-form-item label="使用时间" prop="bomUseDate">
...
export default {
  ...
  created() {
    document['pagePath'] = '/apsOrderGoodsBom0'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsOrderGoodsBom0List = response.dataList
