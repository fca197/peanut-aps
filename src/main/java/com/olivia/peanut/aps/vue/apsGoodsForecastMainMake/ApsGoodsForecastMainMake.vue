  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="编码" prop="forecastMakeMainNo">
        <el-input v-model="queryParams.data.forecastMakeMainNo" clearable placeholder="请输入编码"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="名称" prop="forecastMakeMainName">
        <el-input v-model="queryParams.data.forecastMakeMainName" clearable placeholder="请输入名称"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="开始时间" prop="forecastMakeMainBeginDate">
        <el-input v-model="queryParams.data.forecastMakeMainBeginDate" clearable placeholder="请输入开始时间"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="结束时间" prop="forecastMakeMainEndDate">
        <el-input v-model="queryParams.data.forecastMakeMainEndDate" clearable placeholder="请输入结束时间"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="apsGoodsForecastMainMakeList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="编码" prop="forecastMakeMainNo">
          <el-input v-model="form.forecastMakeMainNo" clearable placeholder="请输入编码"/>
        </el-form-item>
        <el-form-item label="名称" prop="forecastMakeMainName">
          <el-input v-model="form.forecastMakeMainName" clearable placeholder="请输入名称"/>
        </el-form-item>
        <el-form-item label="开始时间" prop="forecastMakeMainBeginDate">
          <el-input v-model="form.forecastMakeMainBeginDate" clearable placeholder="请输入开始时间"/>
        </el-form-item>
        <el-form-item label="结束时间" prop="forecastMakeMainEndDate">
          <el-input v-model="form.forecastMakeMainEndDate" clearable placeholder="请输入结束时间"/>
        </el-form-item>
        <el-form-item label="工厂ID" prop="factoryId">
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        forecastMakeMainNo: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
        }],
        forecastMakeMainName: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
        }],
        forecastMakeMainBeginDate: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
        }],
        forecastMakeMainEndDate: [{required: true, message: "不能为空", trigger: "blur"}, {
          min: 5,
          max: 20,
          message: '长度在 5 到 20 个字符',
          trigger: 'blur'
  ...
  methods: {
    ...
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsGoodsForecastMainMakeList = response.dataList
