<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="商品bom表id" prop="goodsBomId">
        <el-input v-model="queryParams.data.goodsBomId" clearable placeholder="请输入商品bom表id"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    </el-form>
    ...
    <el-table v-loading="loading" :data="apsSchedulingGoodsBomList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="商品bom表id" prop="goodsBomId">
          <el-input v-model="form.goodsBomId" clearable placeholder="请输入商品bom表id"/>
        </el-form-item>
...
export default {
  ...
  created() {
    document['pagePath'] = '/apsSchedulingGoodsBom'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsSchedulingGoodsBomList = response.dataList
