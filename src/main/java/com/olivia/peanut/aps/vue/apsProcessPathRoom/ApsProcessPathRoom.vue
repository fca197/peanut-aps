<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      <el-form-item label="${column.comment}" prop="processPathId">
        <el-input v-model="queryParams.data.processPathId" clearable placeholder="请输入${column.comment}"
    ...
    <el-table v-loading="loading" :data="apsProcessPathRoomList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="${column.comment}" prop="processPathId">
          <el-input v-model="form.processPathId" clearable placeholder="请输入${column.comment}"/>
        </el-form-item>
        <el-form-item label="${column.comment}" prop="roomId">
...
export default {
  ...
  created() {
    document['pagePath'] = '/apsProcessPathRoom'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsProcessPathRoomList = response.dataList
